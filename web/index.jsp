<%-- 
    Document   : index
    Created on : 18/09/2020, 03:44:47
    Author     : Toshiba
--%>
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-auto">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="txt_producto" id="txt_producto" class="form-control" placeholder="xd" required>    
                </div>
                <br>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_descripcion" id="txt_descripcion" class="form-control" placeholder="xd" required> 
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_pcosto" id="txt_pcosto" class="form-control" placeholder="xd" required> 
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_pventa" id="txt_pventa" class="form-control" placeholder="xd" required> 
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="txt_existencia" id="txt_existencia" class="form-control" placeholder="xd" required>
                </div>
